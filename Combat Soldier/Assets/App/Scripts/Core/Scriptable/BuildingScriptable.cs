...
namespace App.Scripts.Core.Scriptable
{
    ...
    public class BuildingScriptable : UnityEngine.ScriptableObject
    {
        ...
        [field: SerializeField] public int AttackWaveCount { get; private set; } = 1;

        [field: SerializeField] public float ReloadingTime { get; private set; } = 3;
        [field: SerializeField] public float TimeBetweenWaves { get; private set; } = 1;
    }
}