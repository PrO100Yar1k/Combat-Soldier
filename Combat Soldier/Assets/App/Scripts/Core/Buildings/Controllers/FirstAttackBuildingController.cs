...
public class FirstAttackBuildingController : BuildingController
{
    ...
    {
        _buildingAttack = new FirstBuildingAttackBehaviour(this, _targetSearchService, _buildingScriptable, _bulletInitialPointList, _rotatingObjectList, _observePoint, _coroutineRunner);
