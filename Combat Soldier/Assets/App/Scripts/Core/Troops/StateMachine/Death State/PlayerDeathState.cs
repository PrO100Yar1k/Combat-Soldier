...
namespace App.Scripts.Core.Troops.StateMachine.Death_State
{
    ...
    {
        public PlayerDeathState(TargetSearchService targetSearchService, TroopController troopController, ISwitchableState switcherState, ITroopAnimator animatorController)
